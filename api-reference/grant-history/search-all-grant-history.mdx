...
curl -X GET 'https://allegory-middleware.ray-392.workers.dev/v1/history?recipient_ein=123456789&limit=100' \
...
curl -X GET 'https://allegory-middleware.ray-392.workers.dev/v1/history?transaction_year=2022&min_amount=50000&limit=100' \
  -H 'X-API-Key: YOUR_API_KEY' \
  -H 'Accept: application/json'
```
</RequestExample>
