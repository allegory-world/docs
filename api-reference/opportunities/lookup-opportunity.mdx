...
<RequestExample>
```bash cURL - Lookup
curl -X GET 'https://allegory-middleware.ray-392.workers.dev/v1/opportunities/lookup?donor=Example%20Foundation&program_name=Climate%20Action%20Grant' \
...
curl -X PUT 'https://allegory-middleware.ray-392.workers.dev/v1/opportunities/lookup?donor=Example%20Foundation&program_name=Climate%20Action%20Grant' \
  -H 'X-API-Key: YOUR_API_KEY' \
